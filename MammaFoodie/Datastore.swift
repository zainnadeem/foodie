...
class DataStore {
    ...
    var currentUser = User(uid: "", username: "", fullName: "", email: "", bio: "", website: "", location: "", follows: [], followedBy: [], profileImageURL: "", dishes: [], reviews: [], notifications: [], broadcasts: [], blockedUsers: [], cart: [], totalLikes: 0, averageRating: 0, deviceTokens: [], isAvailable: false, tags: [], addresses: [], stripeCustomerId: "", stripeAccountId: "", phoneNumber: "")
